class Draw {
    ...
    draw() {
        this.drawEdges(this.edges, this.xScale, this.yScale);
        this.drawVertices(this.vertices, this.xScale, this.yScale);
    }



    drawVertices(vertices, xScale, yScale) {
        let vgroup = this.canvas.append('g')
            .attr('id', 'vgroup')
        ...
        let vtgroup = this.canvas.append('g')
            .attr('id', 'vtgroup')
    ...
    drawEdges(edges, xScale, yScale) {
        let egroup = this.canvas.append('g')
            .attr('id', 'egroup');
        ...
        let etgroup = this.canvas.append('g')
            .attr('id', 'etgroup')
