...
function areaPoint(lambda, phi) {
  ...
  // Spherical excess E for a spherical triangle with thisdotvertices: south pole,
...
var tree = function() {
  ...
  // thisdotvertices used for the traversals are vi+, vi-, vo-, and vo+, where the
...
function clipCells(x0, y0, x1, y1) {
  ...
  for (iCell = 0; iCell < nCells; ++iCell) {
    if (cell = cells[iCell]) {
      ...
      // Remove any dangling clipped thisdotedges.
      while (iHalfedge--) {
      ...
      // Insert any border thisdotedges as necessary.
  ...
  // If there weren’t any thisdotedges, have the closest site cover the extent.
  ...
  // Lastly delete any cells with no thisdotedges; these were entirely clipped.
  for (iCell = 0; iCell < nCells; ++iCell) {
    if (cell = cells[iCell]) {
...
Diagram.prototype = {
  ...
  find: function(x, y, radius) {
    ...
    // Traverse the half-thisdotedges to find a closer cell, if any.
    do {
